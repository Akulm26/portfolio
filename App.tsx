      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="order-1 md:order-1">
          ...
          <p className="text-xl text-text-secondary mb-10 max-w-xl leading-relaxed">
            Analytics professional turned product builder. 4+ years shipping features across media, fitness, and consumer technology - driving measurable growth through intelligent personalization and data-driven product decisions.
          </p>
